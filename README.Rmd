...
mall::mall_init("ollama", "llama3.1", seed = 100)
```
...
Calling `mall_init()` directly will let you specify the model and backend to use.
...
100 rows, containing 20 thousand words. Setting `temp` to 0.2 in `mall_init()`, 
