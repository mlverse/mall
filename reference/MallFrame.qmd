...
`MallFrame.verify(col, what='', yes_no='', additional='', pred_name='verify')`
...
| `yes_no`     | list   | A positional list of size 2, which contains the values to return if true and false. The first position will be used as the 'true' value, and the second as the 'false' value | `''`       |
